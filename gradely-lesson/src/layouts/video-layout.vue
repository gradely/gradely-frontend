    ...
    <header class="main-layout__header">
      <div class="main-layout__header--inner">
        ...
        <div class="w-100 d-flex flex-column align-items-center">
          <div class="main-layout__heading text-center font-weight-700">Video Lessons</div>
...
.main-layout {
  ...
  &__header {
    ...
    background-image: url('../assets/static/slidelesson-header.png');
    background-color: #60d2b0;
