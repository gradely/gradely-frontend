    ...
    <template slot="modal-cover-body">
      <div class="modal-cover-body">
        <div class="feedback-modal">
          <!-- TITLE TEXT  -->
          <div class="title-text">What is wrong with the comment?</div>
...
export default {
  ...
  methods: {
    ...mapActions({ reportFeedComment: "dbFeeds/reportFeedComment" }),

    reportPost() {
      this.handleClick("reportBtn", "Reporting...");

      this.reportFeedComment(this.form)
        .then((response) => {
          ...
          if (response.code === 200) {
            ...
            this.pushAlert("Comment was not reported", "warning");
          }
        })
        .catch(() => {
          this.handleClick("reportBtn", "Report", false);
          this.pushAlert("An error occured while reporting comment", "error");
        });
    },
  },
};
